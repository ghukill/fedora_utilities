...
try:
	...
	print "couldn't create images object"
...
try:
	...
	print "could not create thumbs object"

## iterate to create tiff object datastreams #######################
...
try:
	...
	print "could not create tiffs object"
...
try:
	...
	print "could not create HTML object"
...
try:
	...
	print "could not create altoXML object"
...
try:
	...
	print "could not create fullbook object"
##############################################################
w.end('objects')
w.close(manifest)
